...
console.log(car33.car_make + " " + car33.car_model + " " + car33.car_year);
...
// let carModels = inventory[inventory];
...
for (let i = 0; i < inventory.length; i++){
    //  carYear.push(inventory[i].car_year)
     console.log(carYear.push(inventory[i].car_year));
}
